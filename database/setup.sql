CREATE DATABASE IF NOT EXISTS `regina_hotel` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `regina_hotel`;
...
-- Create trigger to update room status when booking status changes
DELIMITER $$
