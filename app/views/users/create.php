<?php
$title = "Add New User - Regina Hotel";
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="role" name="role" required>
                                    ...
                                    <?php if (SessionManager::getUserRole() === 'Owner'): ?>
                                        <option value="Owner" <?= ($form_data['role'] ?? '') === 'Owner' ? 'selected' : '' ?>>Owner</option>
                                    <?php endif; ?>
                                    <option value="Admin" <?= ($form_data['role'] ?? '') === 'Admin' ? 'selected' : '' ?>>Admin</option>
                                    <option value="Receptionist" <?= ($form_data['role'] ?? '') === 'Receptionist' ? 'selected' : '' ?>>Receptionist</option>
                                </select>
                                <?php if (SessionManager::getUserRole() !== 'Owner'): ?>
                                    <div class="form-text">Note: Only Owner can create other Owner accounts.</div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><strong>Admin:</strong> User management, reporting</li>
                    <li><strong>Receptionist:</strong> Bookings, check-in/out</li>
                </ul>
